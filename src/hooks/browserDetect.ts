...
export const browserDetect = (userAgent = "") => {
  ...
  if (browser === "samsung" && Number(versionMajor) < 14) {
    isOutdated = true;
  } else if (
    ...
    Number(versionMajor) < 78
  ) {
    isOutdated = true;
  } else if (browser === "safari" && Number(versionMajor) < 13) {
    isOutdated = true;
  } else if (browser === "firefox" && Number(versionMajor) < 78) {
    isOutdated = true;
  }
